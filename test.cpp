...
TEST(is_intersects, different_hemisphere)
{
    ...
    ASSERT_FALSE(is_intersects(seg1,seg2));
}

TEST(is_intersects, equator_cross_true)
{
    ...
    Segment seg1 = Segment(&p1,&p2);
    Segment seg2 = Segment(&p3,&p4);
    ASSERT_TRUE(is_intersects(seg1,seg2));
}

TEST(is_intersects, equator_cross_false)
{
    Point<double> p1 = get_euclide_coords(rad,m_pi/2,0);
    Point<double> p2 = get_euclide_coords(rad,m_pi/2,m_pi/2);
...
TEST(is_intersects, common_false_1)
{
    Point<double> p1 = get_euclide_coords(rad,m_pi/2,0);
    Point<double> p2 = get_euclide_coords(rad,m_pi/2,m_pi/2);
...
TEST(is_intersects, common_true_1)
{
    Point<double> p1 = get_euclide_coords(rad,m_pi/2,0);
    Point<double> p2 = get_euclide_coords(rad,m_pi/2,m_pi/2);
    Point<double> p3 = get_euclide_coords(rad,m_pi/4,m_pi/4);
...
TEST(is_intersects, common_touch_true_1)
{
    Point<double> p1 = get_euclide_coords(rad,m_pi/2,0);
    Point<double> p2 = get_euclide_coords(rad,m_pi/2,m_pi/2);
    Point<double> p3 = get_euclide_coords(rad,m_pi/4,m_pi/4);
