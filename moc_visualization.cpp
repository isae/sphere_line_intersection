...
**
** Created: Tue Apr 15 22:25:54 2014
...
static const char qt_meta_stringdata_Visualization[] = {
    "Visualization\0"
};
...
const QMetaObjectExtraData Visualization::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Visualization::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Visualization,
      qt_meta_data_Visualization, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Visualization::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Visualization))
