...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Apr 15 23:52:29 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/practice21.0.0/ && $(COPY_FILE) --parents has_intersection.h .tmp/practice21.0.0/ && $(COPY_FILE) --parents main.cpp test.cpp .tmp/practice21.0.0/ && (cd `dirname .tmp/practice21.0.0` && $(TAR) practice21.0.0.tar practice21.0.0 && $(COMPRESS) practice21.0.0.tar) && $(MOVE) `dirname .tmp/practice21.0.0`/practice21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/practice21.0.0
